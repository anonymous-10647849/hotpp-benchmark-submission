...
# Updates notes since initial submission
1. ODE-RNN baseline
2. Better NHP hyper-parameters
3. Fixed HYPRO implementation (sampling instead of expectation and context dependency)
4. Notebooks for testing thinning and RNN speed

Notebooks:
1. compare-models: Compare our implementation of NHP and ODE-RNN with alternatives.
2. compare-thinning: Compare thinning algorithm implementations from HoTPP and EasyTPP.
3. generation-speed: Compare HoTPP parallel autoregressive inference for multiple locations with simple prefix extension.
